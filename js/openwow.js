                    ...
                    if (openwowTooltips.icons && data.icon && (type == TYPE_ITEM || type == TYPE_ACHIEVEMENT || type == TYPE_SPELL)) {
                        if (external) {
                            ...
                            if (openwowTooltips.iconsize) {
                                t.innerHTML = t.innerHTML + '<img style="width: ' + openwowTooltips.iconsize + 'px; height: ' + openwowTooltips.iconsize + 'px;" src="//cdn.openwow.com/' + domain + '/icons/large/' + data.icon.toLocaleLowerCase() + '.jpg">';
                            } else {
                                t.innerHTML = t.innerHTML + '<img style="width:15px; height:15px;" src="//cdn.openwow.com/' + domain + '/icons/large/' + data.icon.toLocaleLowerCase() + '.jpg">';
                            }
                        } else {
                            t.className += " icontinyl";
                            t.style.background = "url(//cdn.openwow.com/" + domain + "/icons/large/" + data.icon.toLocaleLowerCase() + ".jpg)";
                        }
                    }
                    if (openwowTooltips.rename) {
